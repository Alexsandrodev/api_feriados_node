...
exports.municipios = exports.estados = void 0;
const t = __importStar(require("drizzle-orm/pg-core"));
exports.estados = t.pgTable('estados', {
...
exports.municipios = t.pgTable('municipios', {
    codigo_ibge: t.varchar('codigo_ibge', { length: 7 }).primaryKey(),
    nome: t.varchar('nome', { length: 256 }),
    estado_id: t.varchar('estado_id', { length: 2 }).references(() => exports.estados.codigo_ibge),
